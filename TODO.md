...
> 来源：2026-07-29 网站审计报告 + 2026-07-30 首页重构
...
- [x] ~~P1-1 About 页面内容不足~~ ✅ 2026-07-30 迁入完整 Service Record + Skills Matrix + AI Workflow
- [x] ~~P1-2 Blog 内容薄弱~~ ✅ 2026-07-29 新增 3 篇深度文章
- [x] ~~P1-3 缺少「面向 HR」的信息层~~ ✅ 2026-07-30 首页 About Preview 增加 At a Glance 数据面板
...
- [x] ~~P2-4 Hero 数据表述精确化~~ ✅ 2026-07-30 首页不再展示原始文件数，改为 −92% 指标
...
- [x] ~~P3-3 面试官经验引用~~ ✅ About 页面已提及
- [x] ~~P3-4 Rust 项目链接~~ ✅ 首页 + 项目页均已链接 WinPaste GitHub
...
- [ ] `/projects/` 页增加 BMS + ServicePioneer 工作项目 spec sheets（当前只有开源项目）

## 已完成

- [x] P0-1 Email/Résumé 占位符 — 替换为 mailto:xhxjxk14@foxmail.com + Blog 链接
- [x] Favicon 及图标完整套件 — 从 ../web/ 复制 + base.njk <head> 引用
- [x] P1-1 About 页面重写 — 个人简介/技术哲学/开源/职业方向 + Service Record + Skills Matrix
- [x] P1-2 Blog 深度文章 3 篇 — Monorepo 避坑 / AI 工作流 / 配置驱动引擎
- [x] 2026-07-30 首页重构 — Hero 精简 + 精选项目卡片 + 专注领域 + 最新文章 + About Preview
- [x] 2026-07-30 内容拆分 — Service Record / Skills Matrix / AI Workflow 从首页迁至 About 页
- [x] 2026-07-30 Ledger 精简 — 技术栈去重，移除版本号，从 16 项压缩到 9 项
